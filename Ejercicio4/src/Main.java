...
1.-Heu d'implementar un dels algorismes d'ordenació que vareu treballar a primer curs del grau. Realment implementareu
   dos algorismes. Un que permeti ordenar tipus que tenguin implementada la interfície Comparable i un altre que permeti
   ordenar qualsevol tipus d'elements mitjançant un Comparator. Abans d'implementar els algorismes els heu d'especificar
   formalment. Heu de documentar el codi amb JavaDoc.

2.-TAD Pila i Coa: heu d'implementar amb punters i amb cursos, i de forma genèrica, aquests TAD amb java. Per a la Pila
   i la Coa heu de definir una Interfície.  A partir de la interfície heu de fer la implementació per punters i la
   implementació per cursors. Si no sabeu quina especificació utilitzar podeu usar la de l'API de Java. Heu de
   documentar el codi amb JavaDoc.
